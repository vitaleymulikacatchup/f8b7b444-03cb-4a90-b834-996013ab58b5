...
export const metadata: Metadata = {
  title: "TechPro - Premier IT Solutions & Consulting Services",
  description: "Transform your business with TechPro's cutting-edge IT solutions. Expert cloud migration, cybersecurity, AI development, and custom software services.",
  keywords: "IT consulting, cloud migration, cybersecurity, custom software development, AI solutions, enterprise software",
  metadataBase: new URL("https://techpro.com"),
  alternates: {
    canonical: "https://techpro.com"
  },
  openGraph: {
    title: "TechPro - Premier IT Solutions & Consulting Services",
    description: "Transform your business with cutting-edge IT solutions from TechPro. Cloud migration, cybersecurity, AI development, and more.",
    siteName: "TechPro",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/8866716/pexels-photo-8866716.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "TechPro - Premier IT Solutions & Consulting Services",
    description: "Transform your business with cutting-edge IT solutions from TechPro.",
    images: ["https://images.pexels.com/photos/8866716/pexels-photo-8866716.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
